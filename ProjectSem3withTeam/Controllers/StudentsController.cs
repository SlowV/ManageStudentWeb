...
namespace ProjectSem3withTeam.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RollNumber,FirstName,LastName,Phone,Email,Avatar,CreatedAt,UpdatedAt,Status")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("RollNumber,FirstName,LastName,Phone,Email,Avatar,CreatedAt,UpdatedAt,Status")] Student student)
        {
